...
owm_API = OWM('ee230d2c39e18a68e88b6aaa434f6adb')
city_is = input('My city is: ')

"""this part doesn't work:
registry = owm_API.city_id_registry()
location = registry.locations_for('Kyiv', country='UA', matching='exact')
city = location[0]
lat = city.lat
lon = city.lon
...
observation = w_mgr.weather_at_place(city_is)
weather = w_mgr.weather_at_place(city_is).weather
